  ...
  if (!medicine) {
    return (
      <div className="container px-4 py-20 text-center">
        ...
        <Link href="/shop" className="text-primary hover:underline mt-4 inline-block">Return to inventory</Link>
      </div>
    );
  }
  ...
  return (
    <div className="container px-4 py-12 md:px-8 max-w-7xl">
      ...
      <div className="flex items-center gap-2 text-sm text-zinc-500 mb-12">
        ...
        <ChevronRight className="h-4 w-4" />
        <span className="text-white font-bold">{medicine.name}</span>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        {/* Left: Image Gallery */}
        <div className="lg:col-span-7 space-y-8">
           <div className="relative aspect-square rounded-[60px] bg-card border border-white/5 overflow-hidden shadow-2xl shadow-zinc-200/50 flex items-center justify-center p-12">
              <Image 
              ...
              <div className="absolute top-8 left-8 flex flex-col gap-3">
                 <Badge className="bg-primary/10 text-primary border-white/5 font-bold px-4 py-1.5 rounded-full text-[10px] tracking-widest uppercase">
                    Premium Quality
                 </Badge>
              ...
              <div className="absolute top-8 right-8 flex flex-col gap-3">
                 <Button variant="outline" size="icon" className="h-12 w-12 rounded-full border-white/5 bg-card shadow-sm hover:text-red-500">
                    <Heart className="h-5 w-5" />
                 </Button>
                 <Button variant="outline" size="icon" className="h-12 w-12 rounded-full border-white/5 bg-card shadow-sm">
           ...
           <div className="grid grid-cols-4 gap-6">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className={`aspect-square rounded-3xl border ${i === 1 ? "border-primary bg-primary/10" : "border-white/5 bg-card"} p-4 flex items-center justify-center cursor-pointer transition-all hover:border-primary`}>
                   <Image 
                    src="/images/medicine_pack_placeholder_1776588054881.png"
                    alt={medicine.name}
                    width={80}
        ...
        <div className="lg:col-span-5 space-y-10">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-extrabold text-white font-heading leading-tight">{medicine.name}</h1>
              <p className="text-zinc-500 font-medium">Manufacturer: <span className="text-white font-bold uppercase tracking-wider">{medicine.manufacturer}</span></p>
            </div>

            <div className="flex items-baseline gap-3">
               <span className="text-4xl font-extrabold text-primary font-heading">${medicine.price.toFixed(2)}</span>
            </div>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-6">
              <div className="flex items-center bg-background rounded-2xl p-1 border border-white/5">
                <Button 
                  variant="ghost" 
                  size="icon" 
                  className="h-12 w-12 rounded-xl hover:bg-card hover:shadow-sm"
              ...
              <div className="text-sm">
                 <p className="font-bold text-white">{medicine.stock > 0 ? "In Stock" : "Out of Stock"}</p>
            ...
            <div className="flex gap-4">
              <Button 
                className="flex-1 h-16 rounded-3xl bg-primary hover:bg-primary font-extrabold text-lg shadow-xl shadow-primary/20 transition-all active:scale-95"
          ...
          <div className="grid grid-cols-2 gap-4">
             <div className="flex items-start gap-4 p-5 rounded-[32px] bg-background border border-white/5">
             ...
             <div className="flex items-start gap-4 p-5 rounded-[32px] bg-background border border-white/5">
                ...
                <div className="space-y-1">
                   <p className="text-sm font-bold text-white">Verified Item</p>
      ...
      <div className="mt-32">
        <Tabs defaultValue="description" className="w-full">
          <TabsList className="w-full justify-start h-auto p-0 bg-transparent gap-10 border-b border-white/5 mb-12">
            <TabsTrigger value="description" className="px-0 pb-6 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent text-xl font-bold text-zinc-400 data-[state=active]:text-white transition-all">
              Description
            </TabsTrigger>
            <TabsTrigger value="info" className="px-0 pb-6 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent text-xl font-bold text-zinc-400 data-[state=active]:text-white transition-all">
              Additional Info
            </TabsTrigger>
            <TabsTrigger value="reviews" className="px-0 pb-6 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent text-xl font-bold text-zinc-400 data-[state=active]:text-white transition-all flex items-center gap-2">
              Reviews <Badge className="bg-white/5 text-zinc-500 border-none font-bold text-xs">{reviews?.length || 0}</Badge>
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="info" className="mt-0">
             <div className="max-w-3xl rounded-[40px] border border-white/5 overflow-hidden shadow-sm">
                   ...
                   <tbody className="divide-y divide-background">
                      {[
                        ...
                        <tr key={i} className="hover:bg-background transition-colors">
                           <td className="p-6 font-bold text-white w-1/3">{row.label}</td>
                           <td className="p-6 text-zinc-400">{row.value}</td>
                        </tr>
                      ))}
                   </tbody>
                </table>
          ...
          <TabsContent value="reviews" className="mt-0">
             <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-4 space-y-8">
                   ...
                   {session ? (
                     <Card className="rounded-[32px] border-white/5 p-8 space-y-6">
                        <div className="space-y-2">
                        ...
                        <textarea 
                          className="w-full min-h-[100px] p-4 rounded-2xl bg-background border-none focus:ring-primary text-sm"
                     ...
                     <div className="p-8 rounded-[32px] bg-background border border-white/5 text-center space-y-4">
                      ...
                      <div key={r.id} className="p-8 rounded-[40px] bg-card border border-white/5 shadow-sm space-y-6">
                         <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                               <div className="h-12 w-12 rounded-2xl bg-primary/10 text-primary flex items-center justify-center font-extrabold text-lg uppercase">
                                  {r.user?.name?.charAt(0) || "U"}
                               </div>
                               <div>
                                  <p className="font-bold text-white">{r.user?.name || "Verified User"}</p>
