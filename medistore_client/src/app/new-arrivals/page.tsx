  ...
  return (
    <div className="container px-4 py-16 md:px-8">
      <div className="max-w-3xl mb-16 space-y-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 text-teal-600 text-xs font-bold uppercase tracking-wider border border-teal-100">
          <Sparkles className="h-3 w-3 fill-current" />
          Just Restocked
        </div>
        <h1 className="text-4xl md:text-6xl font-extrabold text-zinc-900 font-heading">New <span className="text-teal-600">Arrivals.</span></h1>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {medicines?.map((med: any) => (
            ...
            >
              <div className="relative bg-zinc-50 p-6 flex items-center justify-center aspect-square">
                <Image 
                ...
                />
                <Badge className="absolute top-4 right-4 bg-teal-500 text-white border-none shadow-md font-bold uppercase text-[8px] tracking-widest px-2 py-0.5">
                  NEW
                </Badge>
              </div>
